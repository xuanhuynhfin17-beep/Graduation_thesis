"""
05g_compare_ppo_td3_quadratic_impact_v3c.py

Quadratic market impact robustness experiment for risk-aware residual-delta deep hedging.

This run compares PPO vs TD3 under nonlinear transaction costs:
    cost = kappa_1 * S * |trade| + kappa_2 * S * trade^2
with LINEAR_TRANSACTION_COST_RATE=0.0005 and QUADRATIC_IMPACT_RATE=0.00005.

Main purpose:
    Compare PPO vs TD3 under the same residual-delta V3C environment with quadratic market impact.
...
Output:
    outputs/comparison_ppo_td3_residual_delta_v3c_quadratic_impact_100k_3seeds.xlsx
    outputs/comparison_ppo_td3_residual_delta_v3c_quadratic_impact_100k_3seeds_step_results.parquet
"""
...
MODEL_DIR = OUTPUT_DIR / "ppo_td3_residual_delta_v3c_quadratic_impact_models"
MODEL_DIR.mkdir(parents=True, exist_ok=True)

EXCEL_OUTPUT_PATH = OUTPUT_DIR / "comparison_ppo_td3_residual_delta_v3c_quadratic_impact_100k_3seeds.xlsx"
STEP_RESULTS_PATH = OUTPUT_DIR / "comparison_ppo_td3_residual_delta_v3c_quadratic_impact_100k_3seeds_step_results.parquet"
...
def make_model(algorithm: str, env: Monitor, seed: int):
    ...
    if algorithm == "PPO":
        return PPO(
            ...
            tensorboard_log=str(OUTPUT_DIR / "tb_logs" / "ppo_td3_residual_delta_v3c_quadratic_impact"),
            seed=seed,
        )
...
for algorithm in ALGORITHMS:
    ...
    for seed in SEEDS:
        print("\n" + "=" * 90)
        print(f"Training QUADRATIC-IMPACT {algorithm} residual-delta V3C, seed={seed}")
        print("=" * 90)
...
all_episode_results["COST_SCENARIO"] = "quadratic_impact_0.00005"
