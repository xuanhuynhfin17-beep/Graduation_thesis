"""
05_compare_algorithms_residual_delta_v3c.py
...
Output:
    outputs/comparison_algorithms_residual_delta_v3c_multiseed.xlsx
    outputs/comparison_algorithms_residual_delta_v3c_step_results.parquet
"""
...
MODEL_DIR = OUTPUT_DIR / "algorithm_comparison_residual_delta_v3c_models"
MODEL_DIR.mkdir(parents=True, exist_ok=True)

EXCEL_OUTPUT_PATH = OUTPUT_DIR / "comparison_algorithms_residual_delta_v3c_td3_multiseed.xlsx"
STEP_RESULTS_PATH = OUTPUT_DIR / "comparison_algorithms_residual_delta_v3c_td3_step_results.parquet"
...
def make_model(algorithm: str, env: Monitor, seed: int):
    ...
    if algorithm == "PPO":
        return PPO(
            ...
            tensorboard_log=str(OUTPUT_DIR / "tb_logs" / "compare_algorithms_residual_delta_v3c"),
            seed=seed,
        )
...
for algorithm in ALGORITHMS:
    ...
    for seed in SEEDS:
        print("\n" + "=" * 90)
        print(f"Training {algorithm} residual-delta V3C, seed={seed}")
        print("=" * 90)
