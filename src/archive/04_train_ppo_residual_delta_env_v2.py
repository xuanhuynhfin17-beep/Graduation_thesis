...
PPO_MODEL_DIR = OUTPUT_DIR / "ppo_residual_delta_v2_models"
PPO_MODEL_DIR.mkdir(parents=True, exist_ok=True)

PPO_COMPARISON_PATH = OUTPUT_DIR / "comparison_baseline_ppo_residual_delta_v2.xlsx"
...
for seed in SEEDS:
    ...
    model = PPO(
        ...
        tensorboard_log=str(OUTPUT_DIR / "tb_logs" / "ppo_residual_delta_v2"),
        seed=seed,
    )
