...
Full 2^3 factorial ablation study for the residual-delta V3C hedging environment.

Purpose:
    Separate main effects and interaction effects among three design factors:
...
MODEL_DIR = OUTPUT_DIR / "ablation_ppo_v3c_full_factorial_models"
MODEL_DIR.mkdir(parents=True, exist_ok=True)

EXCEL_OUTPUT_PATH = OUTPUT_DIR / "ablation_ppo_v3c_full_factorial_100k_3seeds.xlsx"
STEP_RESULTS_PATH = OUTPUT_DIR / "ablation_ppo_v3c_full_factorial_100k_3seeds_step_results.parquet"
...
# Full factorial ablation variants.
# R = residual-delta geometry, N = no-trade band, K = risk-aware reward.
# K activates downside penalty and delta-risk penalty together.
# Transaction costs remain part of wealth dynamics for all variants.
ABLATION_VARIANTS = [
    {
        "VARIANT": "F000_direct_ppo",
        "FACTOR_R": 0,
        "FACTOR_N": 0,
        "FACTOR_K": 0,
        "DESCRIPTION": "Direct PPO: direct hedge-ratio learning, no no-trade band, no risk-aware reward.",
    ...
    {
        "VARIANT": "F010_direct_ppo_no_trade",
        "FACTOR_R": 0,
        "FACTOR_N": 1,
        "FACTOR_K": 0,
        "DESCRIPTION": "Direct PPO with fixed no-trade band.",
        "RESIDUAL_DELTA": False,
        "ADJUSTMENT_LIMIT": None,
    ...
    {
        "VARIANT": "F001_direct_ppo_risk",
        "FACTOR_R": 0,
        "FACTOR_N": 0,
        "FACTOR_K": 1,
        "DESCRIPTION": "Direct PPO with downside and Delta-risk penalties, no no-trade band.",
        "RESIDUAL_DELTA": False,
        "ADJUSTMENT_LIMIT": None,
        "NO_TRADE_BAND": 0.00,
    ...
    {
        "VARIANT": "F011_direct_ppo_no_trade_risk",
        "FACTOR_R": 0,
        "FACTOR_N": 1,
        "FACTOR_K": 1,
        "DESCRIPTION": "Direct PPO with fixed no-trade band and risk-aware reward.",
        "RESIDUAL_DELTA": False,
        "ADJUSTMENT_LIMIT": None,
        "NO_TRADE_BAND": DEFAULT_NO_TRADE_BAND,
        "DOWNSIDE_PENALTY": 0.50,
    ...
    {
        "VARIANT": "F100_residual_only",
        "FACTOR_R": 1,
        "FACTOR_N": 0,
        "FACTOR_K": 0,
        "DESCRIPTION": "Residual-delta PPO without no-trade band and without risk-aware reward.",
        "RESIDUAL_DELTA": True,
    ...
    {
        "VARIANT": "F110_residual_no_trade",
        "FACTOR_R": 1,
        "FACTOR_N": 1,
        "FACTOR_K": 0,
        "DESCRIPTION": "Residual-delta PPO with fixed no-trade band, no risk-aware reward.",
        "RESIDUAL_DELTA": True,
        "ADJUSTMENT_LIMIT": DEFAULT_ADJUSTMENT_LIMIT,
        "NO_TRADE_BAND": DEFAULT_NO_TRADE_BAND,
        "DOWNSIDE_PENALTY": 0.00,
    ...
    {
        "VARIANT": "F101_residual_risk",
        "FACTOR_R": 1,
        "FACTOR_N": 0,
        "FACTOR_K": 1,
        "DESCRIPTION": "Residual-delta PPO with risk-aware reward, no no-trade band.",
        "RESIDUAL_DELTA": True,
        "ADJUSTMENT_LIMIT": DEFAULT_ADJUSTMENT_LIMIT,
        "NO_TRADE_BAND": 0.00,
        "DOWNSIDE_PENALTY": 0.50,
    ...
    {
        "VARIANT": "F111_full_v3c",
        "FACTOR_R": 1,
        "FACTOR_N": 1,
        "FACTOR_K": 1,
        "DESCRIPTION": "Full V3C: residual-delta PPO with no-trade band and risk-aware reward.",
        "RESIDUAL_DELTA": True,
        "ADJUSTMENT_LIMIT": DEFAULT_ADJUSTMENT_LIMIT,
        "NO_TRADE_BAND": DEFAULT_NO_TRADE_BAND,
        "DOWNSIDE_PENALTY": 0.50,
...
print(FEATURE_COLS)
print("\nAblation variants:")
print(pd.DataFrame(ABLATION_VARIANTS)[["VARIANT", "FACTOR_R", "FACTOR_N", "FACTOR_K", "DESCRIPTION"]])
...
def make_model(env: Monitor, seed: int) -> PPO:
    return PPO(
        ...
        tensorboard_log=str(OUTPUT_DIR / "tb_logs" / "ablation_ppo_v3c_full_factorial"),
        seed=seed,
    )
...
factorial_effects_test = make_factorial_effects(ablation_summary, split="test")
...
print("\nFactorial effects on test split:")
print(factorial_effects_test)

FACTORIAL_LATEX_TABLE_PATH = OUTPUT_DIR / "table_full_factorial_ablation_results.tex"
make_factorial_latex_table(ablation_summary, FACTORIAL_LATEX_TABLE_PATH, split="test")
print("\nSaved full factorial LaTeX table:")
print(FACTORIAL_LATEX_TABLE_PATH)
...
with pd.ExcelWriter(EXCEL_OUTPUT_PATH, engine="openpyxl") as writer:
    ...
    factorial_effects_test.to_excel(writer, sheet_name="Factorial_Effects_Test", index=False)
