...
PPO_MODEL_PATH = OUTPUT_DIR / "ppo_50k_call_hedging_only_with_spy"
PPO_COMPARISON_PATH = OUTPUT_DIR / "comparison_baseline_ppo_call_only_50k_with_spy.xlsx"
...
ppo_steps, ppo_ep = evaluate_rl_model_call_only(
    ...
    strategy_name="ppo_50k_call_only",
    deterministic=True,
    hedge_limit=HEDGE_LIMIT_RL,
    transaction_cost_rate=TRANSACTION_COST_RATE,
