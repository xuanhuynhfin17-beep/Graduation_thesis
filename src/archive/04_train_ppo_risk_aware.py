...
PPO_MODEL_PATH = OUTPUT_DIR / "ppo_50k_call_only_risk_aware_with_spy"
PPO_COMPARISON_PATH = OUTPUT_DIR / "comparison_baseline_ppo_risk_aware_50k_with_spy.xlsx"
...
ppo_steps, ppo_ep = evaluate_rl_model_call_only(
    ...
    strategy_name="ppo_50k_risk_aware",
    deterministic=True,
    hedge_limit=HEDGE_LIMIT_RL,
    transaction_cost_rate=TRANSACTION_COST_RATE,
