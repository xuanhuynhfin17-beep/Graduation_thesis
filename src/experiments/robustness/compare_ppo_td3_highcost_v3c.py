"""
05d_compare_ppo_td3_highcost_v3c.py

Comparative DRL experiment for risk-aware residual-delta deep hedging.

Main purpose:
    High transaction cost robustness: compare PPO vs TD3 under the same residual-delta V3C environment.

Environment:
    - High transaction cost robustness setting: LINEAR_TRANSACTION_COST_RATE = 0.001.
...
Output:
    outputs/comparison_ppo_td3_residual_delta_v3c_highcost_100k_3seeds.xlsx
    outputs/comparison_ppo_td3_residual_delta_v3c_highcost_100k_3seeds_step_results.parquet
"""
...
MODEL_DIR = OUTPUT_DIR / "ppo_td3_residual_delta_v3c_highcost_models"
MODEL_DIR.mkdir(parents=True, exist_ok=True)

EXCEL_OUTPUT_PATH = OUTPUT_DIR / "comparison_ppo_td3_residual_delta_v3c_highcost_100k_3seeds.xlsx"
STEP_RESULTS_PATH = OUTPUT_DIR / "comparison_ppo_td3_residual_delta_v3c_highcost_100k_3seeds_step_results.parquet"
...
def make_model(algorithm: str, env: Monitor, seed: int):
    ...
    if algorithm == "PPO":
        return PPO(
            ...
            tensorboard_log=str(OUTPUT_DIR / "tb_logs" / "ppo_td3_residual_delta_v3c_highcost"),
            seed=seed,
        )
...
for algorithm in ALGORITHMS:
    ...
    for seed in SEEDS:
        print("\n" + "=" * 90)
        print(f"Training HIGH-COST {algorithm} residual-delta V3C, seed={seed}")
        print("=" * 90)
...
all_episode_results["COST_SCENARIO"] = "high_cost_0.001"
