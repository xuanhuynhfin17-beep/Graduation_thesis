"""
05a_sac_v3c_paper_like_quick.py

SAC-A quick diagnostic for risk-aware residual-delta deep hedging.

This run uses SAC only with paper-like hyperparameters: learning_rate=1e-4, buffer_size=600_000, batch_size=1000, tau=0.05, ReLU activation, SEEDS=[1], TOTAL_TIMESTEPS=50_000.

Main purpose:
    Compare PPO vs SAC vs TD3 under the same residual-delta V3C environment.
...
Output:
    outputs/comparison_sac_v3c_paper_like_quick.xlsx
    outputs/comparison_sac_v3c_paper_like_quick_step_results.parquet
"""
...
MODEL_DIR = OUTPUT_DIR / "comparison_sac_v3c_paper_like_100k_3seeds"
MODEL_DIR.mkdir(parents=True, exist_ok=True)

EXCEL_OUTPUT_PATH = OUTPUT_DIR / "comparison_sac_v3c_paper_like_100k_3seeds.xlsx.xlsx"
STEP_RESULTS_PATH = OUTPUT_DIR / "comparison_sac_v3c_paper_like_100k_3seeds.parquet"
...
def make_model(algorithm: str, env: Monitor, seed: int):
    ...
    if algorithm == "PPO":
        return PPO(
            ...
            tensorboard_log=str(OUTPUT_DIR / "tb_logs" / "comparison_sac_v3c_paper_like_100k_3seeds"),
            seed=seed,
        )
...
for algorithm in ALGORITHMS:
    ...
    for seed in SEEDS:
        print("\n" + "=" * 90)
        print(f"Training SAC-A paper-like residual-delta V3C, seed={seed}")
        print("=" * 90)
